...
exports.analyzeFoodPFC = functions
    ...
    try {
        ...
        if (!text || typeof text !== "string" || !text.trim()) {
            throw new functions.https.HttpsError("invalid-argument", "Parameter 'text' must be a non-empty string.");
        }
...
`;
        ...
        if (!raw) {
            throw new functions.https.HttpsError("internal", "Failed to get content from OpenAI response.");
        }
        let parsed;
        try {
            ...
            throw new functions.https.HttpsError("internal", "Failed to parse OpenAI response as JSON.");
        }
        ...
        throw new functions.https.HttpsError("internal", error?.message || "Unknown error in analyzeFoodPFC.");
    }
});
